	...
	<div class="container">
		...
		<div class="row">
			<form action="CommonController" method="get" class="mb-3 text-center">
				...
				<div class="col-md-6">
					<input name="command" value="searchByAccountNumber" type="hidden" />
					 <input
						type="text" id="accountNumber" name="searchByAccountNumber"
						class="form-control" placeholder="search by account number">
			...
			<form action="CommonController" method="get" class="mb-3 text-center">
				...
				<div class="col-md-6">
					<input name="command" value="searchByFirstName" type="hidden" /> <input
						type="text" id="firstName" name="searchByFirstName"
		...
		<div class="text-end mb-3">
			<a href="/mybanknetbanking/CommonController?sortBy=name"
				class="btn btn-secondary">Sort by Name</a>
		</div>
