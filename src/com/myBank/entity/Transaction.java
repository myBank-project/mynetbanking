...
public class Transaction {
	...
	public Transaction(int transactionId, int senderAccountNumber, int receiverAccountNumber, Date transactionDate,
	...
	public Transaction(int senderAccountNumber, int receiverAccountNumber, Date transactionDate, String transactionType,int transactionAmount) {
		this.senderAccountNumber = senderAccountNumber;
		this.receiverAccountNumber = receiverAccountNumber;
		this.transactionDate = transactionDate;
		this.transactionType =TransactionType.valueOf(transactionType.toUpperCase());
